...
print('', len(timeList))
print('Total ^')
#print('\nYou highlighted ', len(timeList), 'slack questions\n')
...
# Remove the :'s
#abc = [['.' if x == ':' else x for x in sl] for sl in timeList]


#dcf = [[''.join([abc]) for i in sl] for sl in abc]
#bcd = [[float(i) for i in sl] for sl in abc]
#print(dcf)

#timeList = [x for numbers in timeList for y in numbers]
